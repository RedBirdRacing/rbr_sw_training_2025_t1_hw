...
int main() {
  ...
  /**
   * HOMEWORK TODO 2: repeat the following code indefinitely, ending before
   * return 0; i.e. keep reading user input and printing the status You don't
   * need to terminate the program in code, use Ctrl+C to stop the program when
   * you want to.
   */
